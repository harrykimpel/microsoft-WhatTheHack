...
Your goal is to configure your application to send traces, metrics, and logs to New Relic using the OTLP (OpenTelemetry Protocol) exporter.
...
- Enhance your spans with attributes that New Relic can use for AI monitoring
- Include model information, token usage, and request context
